...
describe("createDynamicLink", () => {
  it(`given query param string without ? prefix, expect append`, async () => {
    ...
    expect(createDynamicLink(givenQueryString)).toMatchInlineSnapshot(
      `"${Env.dynamicLinkHostname}/?link=https%3A%2F%2Fapp.foo.com%2F%3Ffoo%3D1%26bar%3Dtrue%26mobile_link%3Dtrue&apn=com.foo.xxx&ibi=com.foo.xxx"`
    )
  })
